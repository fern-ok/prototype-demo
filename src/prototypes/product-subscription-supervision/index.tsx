  ...
  seedData.forEach(function (product) {
    ...
    for (let i = 0; i < total; i++) {
      ...
      list.push({
        ...
        auditTime: status === '待审核' ? '—' : '2026-08-' + day + ' ' + auditHour + ':' + pad((i * 11) % 60) + ':00',
        status: status
      });
      seq += 1;
    }
...
const OriginalComponent = () => {
  ...
  const detailOrders = useMemo(() => {
    ...
    return orderSeed.filter(function (o) { return o.productId === currentRecord.id; });
  }, [currentRecord]);
  ...
  const renderFilter = () => (
    <div className="filter-section">
      ...
      <div className="filter-row">
        ...
        <div className="filter-item">
          <label>订阅次数</label>
          <input type="text" placeholder="请输入" value={searchSubscribeCount} onChange={(e) => setSearchSubscribeCount(e.target.value)} />
        </div>
      </div>
        ...
        <table className="data-table">
          <thead>
            <tr>
              ...
              <th className="col-subscribe-count">订阅次数</th>
                ...
                <tr key={record.id}>
                  ...
                  <td className="col-action">
                    <div className="action-buttons">
                      ...
                      <button className="action-btn" onClick={() => handleViewDetail(record)}>查看订阅明细</button>
                    </div>
                  </td>
                </tr>
              ))
      ...
      <div className="modal-large" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <div className="detail-product-tip">
            产品名称：{currentRecord?.productName}　|　产品类型：{currentRecord?.productType}　|　产品提供方：{currentRecord?.provider}
          </div>
