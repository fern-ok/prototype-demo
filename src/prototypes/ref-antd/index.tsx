        ...
        <Layout.Content className="ecommerce-dashboard">
          ...
          <Row gutter={[20, 20]} className="metric-cards">
            <Col xs={24} sm={12} lg={6}>
              <Card variant="filled" styles={{ body: { padding: '20px 24px' } }}>
                <Statistic
                  title="总销售额"
                  value={126560}
                  precision={2}
          ...
          <Row gutter={[20, 20]} style={{ marginTop: 20 }}>
            ...
            <Col xs={24} lg={8}>
              <Card title={<span style={{ fontWeight: 600 }}>销售品类占比</span>} variant="filled" style={{ height: '100%' }}>
                <CategoryPieChart />
              </Card>
            </Col>
          </Row>
          ...
          <Row gutter={[20, 20]} style={{ marginTop: 20 }}>
            <Col xs={24} lg={16} style={{ display: 'flex' }}>
              <Card 
                ...
                styles={{ body: { flex: 1, padding: 24, overflow: 'hidden' } }}
              >
                <Table
                  columns={columns}
                  dataSource={orders}
